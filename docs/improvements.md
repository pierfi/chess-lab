...
**Nota (19 luglio 2026):** l'utente ha approfondito la stessa idea in una conversazione ChatGPT separata; la risposta è stata valutata criticamente e le parti utili/da scartare/da ridimensionare sono raccolte in [`docs/lesson-sourcing-pipeline-notes.md`](lesson-sourcing-pipeline-notes.md) — note di ricerca, non ancora un design doc.
